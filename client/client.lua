...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if isVehicleELS and canControlELS then
            ...
            if GetVehicleClass(current_vehicle) == 18 then
            ...
            SetVehRadioStation(current_vehicle, "OFF")
            SetVehicleRadioEnabled(current_vehicle, false)
            ...
            if(GetLastInputMethod(0)) then
                ...
                if IsDisabledControlPressed(0, keyboard.modifyKey) then
                    ...
                    if IsDisabledControlJustReleased(0, keyboard.stageChange) then
                        if getVehicleVCFInfo(current_vehicle).interface.activationType == "invert" or getVehicleVCFInfo(current_vehicle).interface.activationType == "euro" then
                            upOneStage()
                        else
                            downOneStage()
                        end
                    ...
                    if IsDisabledControlJustReleased(0, keyboard.warning) then
                        ...
                        if elsVehs[current_vehicle] ~= nil then
                            if elsVehs[current_vehicle].warning then
                    ...
                    if IsDisabledControlJustReleased(0, keyboard.secondary) then
                        ...
                        if elsVehs[current_vehicle] ~= nil then
                            if elsVehs[current_vehicle].secondary then
                    ...
                    if IsDisabledControlJustPressed(0, keyboard.primary) then
                        ...
                        if elsVehs[current_vehicle] ~= nil then
                            if elsVehs[current_vehicle].primary then
                ...
                if GetVehicleClass(current_vehicle) == 18 then
                    if (elsVehs[current_vehicle] ~= nil) then
                        if elsVehs[current_vehicle].stage == 3 then
                        ...
                        if elsVehs[current_vehicle].stage == 2 then
                            if IsDisabledControlJustReleased(0, keyboard.siren.tone_one) then
                                if playButtonPressSounds then
                                    PlaySoundFrontend(-1, "NAV_UP_DOWN", "HUD_FRONTEND_DEFAULT_SOUNDSET", 1)
                                end
                ...
                if els_Vehicles[checkCarHash(current_vehicle)].activateUp then
                ...
                if canControlELS then
                    ...
                    if vehN ~= 0 then
                        if (panelType == "original") then
                            ...
                            if (getVehicleLightStage(current_vehicle) == 1) then
                            ...
                            if (getVehicleLightStage(current_vehicle) == 2) then
                            ...
                            if (getVehicleLightStage(current_vehicle) == 3) then
                            ...
                            if (IsVehicleExtraTurnedOn(current_vehicle, 11)) then
                            ...
                            if(IsVehicleExtraTurnedOn(current_vehicle, 7)) then
                            ...
                            if getVehicleVCFInfo(vehN).secl.type == "traf" or getVehicleVCFInfo(vehN).secl.type == "chp" then
                                if(IsVehicleExtraTurnedOn(current_vehicle, 8)) then
                            ...
                            if(IsVehicleExtraTurnedOn(current_vehicle, 9)) then
                            ...
                            if(IsVehicleExtraTurnedOn(current_vehicle, 1)) then
                            ...
                            if(IsVehicleExtraTurnedOn(current_vehicle, 2)) then
                            ...
                            if(IsVehicleExtraTurnedOn(current_vehicle, 3)) then
                            ...
                            if(IsVehicleExtraTurnedOn(current_vehicle, 4)) then
                            ...
                            if(IsVehicleExtraTurnedOn(current_vehicle, 5)) then
                            ...
                            if(IsVehicleExtraTurnedOn(current_vehicle, 6)) then
                            ...
                            if elsVehs[current_vehicle] ~= nil then
                                if elsVehs[current_vehicle].cruise then
                            ...
                            if IsVehicleExtraTurnedOn(current_vehicle, 12) then
    ...
    while true do
        for k,v in pairs(elsVehs) do
            if(v ~= nil or DoesEntityExist(k)) then
                if (GetDistanceBetweenCoords(GetEntityCoords(k, true), GetEntityCoords(current_ped, true), true) <= vehicleSyncDistance) then
...
Citizen.CreateThread(function()
    ...
    while true do
        for k,v in pairs(elsVehs) do
            if (v ~= nil and DoesEntityExist(k) and GetDistanceBetweenCoords(GetEntityCoords(k, true), GetEntityCoords(current_ped, true), true) <= vehicleSyncDistance) then
